...
Tags: full-site-editing, block-theme, accessibility-ready, custom-colors, grid-layout, wide-blocks, one-column, two-columns, custom-header, editor-style  
Text Domain: Novi  

== Description ==

**Novi** è un tema moderno a blocchi pensato per l'Editor del sito completo (FSE), con massima attenzione a prestazioni, flessibilità e pulizia del codice.

Il tema include layout predefiniti per post e pagine, header e footer a blocchi, selettore di stili, libreria di stili per blocchi e sezioni, selezione font e molto altro.

Novi è progettato per essere **leggero** e **velocissimo**.

== Features ==

- Tema FSE completamente personalizzabile  
- Template e pattern pronti all'uso  
- Selettore di stili e font  
- Ottimizzazione per WooCommerce  
- Caricamento asset condizionale  

== Copyright ==

Novi WordPress Theme, (C) 2024-2025 WordPress.org and contributors.
Novi is distributed under the terms of the GNU GPL.
...
All the images are my own creation.

Le icone e il logo sono create dall’autore del tema.


== Fonts ==

Bitter font
Copyright 2011 The Bitter Project Authors (https://github.com/solmatas/BitterPro) with Reserved Font Name "Bitter Pro".
This Font Software is licensed under the SIL Open Font License, Version 1.1 . This license is copied below, and is also available with a FAQ at: https://openfontlicense.org
Source: https://fonts.google.com/specimen/Bitter/license


Comfortaa font
Copyright 2011 The Comfortaa Project Authors (https://github.com/alexeiva/comfortaa), with Reserved Font Name "Comfortaa".
This Font Software is licensed under the SIL Open Font License, Version 1.1 . This license is copied below, and is also available with a FAQ at: https://openfontlicense.org
Source: https://fonts.google.com/specimen/Comfortaa/license
...
1. Carica la cartella del tema nella directory `/wp-content/themes/`
2. Attiva il tema dal menu "Aspetto > Temi" nella tua dashboard di WordPress
3. Personalizza il tuo sito con l'Editor del sito completo

== Changelog ==

10/06/25
spacing size adjusted
add custom font-wheight and line-height
add new images
add new palette
