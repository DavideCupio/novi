...
<?php if (is_front_page()) : ?>
    ...
    ?>
    <section class="page-header alignwide" aria-labelledby="page-header-title" style="background-image: url('<?php echo esc_url($background_image); ?>'); background-size: cover;
...
<?php elseif (is_home() || is_archive()) : ?>
    ...
    ?>
    <section class="page-header alignwide" aria-label="<?php echo esc_attr(get_the_title($blog_page_id)); ?>"
